# -*- coding: utf-8 -*-
"""
Created on Thu Nov 30 19:04:30 2017
...
#        self.configure(background='black')
        ...
        def checkForSpam():
            ...
            if "N" in text1.cget("text"):
                ...
                Page2.label.config(text=("\n".join(self.not_spam_list)), fg='white', bg='black', font=("Museo Sans", 15, "bold"))
            else:
                self.spam_list.append(e.get())
                Page3.label.config(text=("\n".join(self.spam_list)), fg='white', bg='black', font=("Museo Sans", 15, "bold"))
